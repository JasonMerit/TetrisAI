...
# import matplotlib # if we import to excel we can combine data
...
while not exit_program:
    ...
    if runai:
        ...
        action_num = greedy_epsilon(q_current)
        ...
        # 3. update q table (if not testing)
        if not testing:
